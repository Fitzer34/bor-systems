# HazardLink — Sales One-Pager

For warm intros, prospect handouts, and follow-up emails.
...
┌─────────────────────────────────────────────────────────────┐
│   HazardLink ⚠️                                              │
│   Smart wet-floor monitoring for commercial facilities       │
└─────────────────────────────────────────────────────────────┘
```
...
When the sign disappears, three things happen:
...
A sub-€1 magnetic sensor inside every wet-floor sign mount. The moment
...
| Heat-map analytics | Identifies repeat-offender zones (leaky vending machines, wet entrances) |
| Slack + Teams integration | Alerts post in the channel cleaning teams already use |

## How it installs

```
1. Wall-mount a hanger where each sign normally lives    (5 min each)
2. Plug a gateway box into power + Wi-Fi                 (10 min, once per building)
3. Hang your existing wet-floor signs on the hangers     (instant)
4. Cleaners install the iPhone / Android app             (5 min each)
5. Done — alerts start immediately
```

## Pricing

| Tier | Site size | Setup | Monthly |
|---|---|---|---|
| **Small** | Up to 10 hangers | €1,500 hardware | €30 / month |
| **Multi-site** | Up to 50 hangers | €6,500 hardware | €100 / month |
| **Enterprise** | 200+ hangers | €25,000+ hardware | €350 / month |

Hardware is a one-time purchase. Software subscription is month-to-month
...
(Pilot phase — willing to share names of design-partner sites once they
agree)

## Why us, why now

- **Built in Ireland**, hosted in EU — your data stays in your jurisdiction
- **No long contracts** — month-to-month, cancel any time
- **GDPR-native** — designed compliance-first, not bolted on
- **No replacement of your existing signs** — we make YOUR signs smart
- **Multi-language** — supports the actual labour pool in UK/IE cleaning
