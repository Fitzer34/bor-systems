...
NEW IN v9.9: THE CLEANING-MODE BUTTON UNDER THE BASE, AND A TALLER HANGER BOX
  ...
  button (6 bought on Amazon UK): M16 thread, a head 18.8 mm across and 3.2 mm high, 19 mm of threaded metal body behind the head, then
  a blue plug-in wire socket 25.6 mm long with five wires, so 44.5 mm behind the head in all. It goes through a 16.4 mm hole in the
  ...
  DOWNWARD by 44 mm: the hanger body is now 174 mm tall (it was 130), the lid is 100 x 174 and the backplate 90 x 168. Every feature
  ...
  are ASSUMED to be 7.5 mm long and have not been measured) would make the box 18 mm shorter (156 tall). BTN16_ON=False builds
...
HOW THE PARTS HOLD TOGETHER
  ...
  Hook bar: T-shaped. The dovetail and web are narrow (web 26 mm); the bar below is 88 mm wide (BAR_W) so it fills the
    sign's hand hole: the sign hangs level and cannot slide sideways off the sensor. BAR_W is PROVISIONAL until the hand
    hole is measured (set it to the hole width minus 17 mm).
  ...
  WHAT HOLDS EACH BOUGHT PART (checked by audit_retention.py: free travel in all six directions, target <= 0.5 mm)
    ...
    Battery: Murata US18650VTC6 cell (18650) in the BeiLaMoo BH18650-PC2 holder (77.7 x 20.9 x 21.3, two solder pins about
      3.3 mm long, one at each end, 2.4 mm in from the end face). The holder stands on three ribs 5 mm off the back wall so
      its pins and the wires soldered to them have room (1.7 mm from pin tip to the back wall), inside ribs on four sides,
...
pointing down. The web at the back carries the bar 46 mm below the body; the bar reaches 86 mm out from the wall face and
ends in a 20 mm lip; the sign's handle settles in the saddle, which is centred 11 mm in front of the body rim (Y=-11, which
is -8 mm BEHIND the lid's outer face), directly over the Hall sensor.
...
MAGNET POSITION ON THE SIGN (the figures a magnet holder on the sign has to be made to)
  ...
  -8 mm behind the lid's outer face), flat face parallel to the saddle floor, facing down. EITHER pole: the DRV5032FA is
...
PRINTING
  ...
  WHAT TO PRINT NOW AND WHAT SHOULD WAIT: PRINT.md's first-print list has the detail. In short, two measurements are still
    open. The hook bar's width (BAR_W, 88 mm) is provisional until the sign's hand hole has been measured, so a hanger_bar
  ...
  hanger_body: back face down, open front up. It is 175 mm long on the bed now. The dovetail channel runs along the print
...
MEASURE BEFORE FREEZING (still to be measured by Owen)
  ...
  The sign's hand hole: width and height, and the folded handle thickness (assumed 38 in a 42 mm saddle; 56 mm is free
    between the lip and the web). BAR_W 88 is provisional; reach 86 and lip 20 are assumed. The magnet position in the
