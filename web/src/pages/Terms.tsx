...
export function Terms() {
  return (
    <article className="prose mx-auto max-w-2xl px-6 py-12 text-slate-800">
      ...
      <h2>1. The deal</h2>
      <p>
        These terms govern your use of the ZeroSlip smart wet-floor-sign
      ...
      <h2>4. The hangers</h2>
      <p>
        Hangers remain ZeroSlip property under any rental plan. You agree
      ...
      <h2>7. Liability</h2>
      <p>
        ZeroSlip is an aid to your cleaning operation. It does not
